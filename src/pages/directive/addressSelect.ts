...
export class AddressSelect implements OnChanges{
  ...
  @Output() countyChange: EventEmitter<string> = new EventEmitter<string>();
  ...
  ngOnChanges(changes){
      ...
      this.provinceList.forEach(
        value=> { if(value.name==this.province) this.cityList = value.sub }
      );
      this.cityList.forEach(
        value=> { if(value.name==this.city) this.countyList = value.sub }
      );
  ...
  change(){
    ...
    this.provinceChange.emit(this.province);
